...
var AddForm = require('../form/addForm.jsx');
var DeleteForm = require('../form/deleteForm.jsx');
var EditForm = require('../form/editForm.jsx');
var SearchForm = require('../form/searchForm.jsx');
...
class ToolsPanel extends React.Component {
    ...
    checkButtonsState() {
        ...
        switch (this.props.category) {
            case 'ST': this.selected = GetDataControl.getStudentById(this.props.selectedElement.student) != null; break;
            case 'CO': this.selected = GetDataControl.getCompanyById(this.props.selectedElement.company) != null; break;
            case 'EV': this.selected = GetDataControl.getEventById(this.props.selectedElement.event) != null; break;
            case 'DT': return
        }
    ...
    renderForm() {
        if (this.state.form == 'ADD') {
            ...
            return <DeleteForm selectedElement={this.props.selectedElement} category={this.props.category}
                cancelHandler={() => this.changeForm('NIL')} deleteHandler={(event) => {this.changeForm('NIL'); this.props.onDeleteHandler(event);}}/>
        }
