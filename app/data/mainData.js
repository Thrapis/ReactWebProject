...
var DataSpecs = ['ИСиТ', 'ПОИТ', 'ПОИБМС', 'ДЭВИ'];

var StudentSorts = ['id', 'name', 'spec', 'group', 'syear'];

var CompanySorts = ['id', 'name'];

var EventSorts = ['id', 'date', 'text'];
...
module.exports = {
	REGIM: REGIM,
	DataSpecs: DataSpecs,
	StudentSorts: StudentSorts,
	CompanySorts: CompanySorts,
